...
#### Network
9. [Bash скрипт](https://github.com/a1k0u/os/blob/main/ip-info.sh),
...
`grep -R -w "[h]{1}.l*[o]+[\W]?(world)?" someFile.txt`. Найдем
все слова, в которые точно выходит одна буква `h`, а после
